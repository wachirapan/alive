...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2021 at 02:51 PM
...
--
-- Table structure for table `abount`
--

CREATE TABLE `abount` (
  `abount_id` int(11) NOT NULL,
  `abount_detal` text COLLATE utf8_unicode_ci NOT NULL,
  `member_id` int(11) NOT NULL,
  `admin` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `abount`
--

INSERT INTO `abount` (`abount_id`, `abount_detal`, `member_id`, `admin`) VALUES
(1, '<p><img src=\"http://alive-dropship.com/images/about/a1.png\" style=\"width: 100%;\"></p><p><img\r\n		src=\"http://alive-dropship.com/images/about/a2.png\" style=\"width: 100%;\"></p><p><img\r\n		src=\"http://alive-dropship.com/images/about/a3.png\" style=\"width: 100%;\"></p><p><img\r\n		src=\"http://alive-dropship.com/images/about/a6.png\" style=\"width: 100%;\"></p><p><img\r\n		src=\"http://alive-dropship.com/images/about/a4.png\" style=\"width: 100%;\"></p><p><img\r\n		src=\"http://alive-dropship.com/images/about/a5.png\" style=\"width: 100%;\"><br></p>', 0, 1);
...
CREATE TABLE `admin` (
  ...
  `admin_userpwd` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `admin` (`admin_id`, `admin_username`, `admin_userpwd`) VALUES
(1, 'admin', '123456');

-- --------------------------------------------------------

--
-- Table structure for table `amount_discount`
--

CREATE TABLE `amount_discount` (
  `amount_discount_id` int(11) NOT NULL,
  `score_before` int(11) NOT NULL,
  `score_after` int(11) NOT NULL,
  `amount_discount_payback` double NOT NULL,
  `amount_discount_create` date NOT NULL,
  `amount_discount_drop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `amount_discount`
--

INSERT INTO `amount_discount` (`amount_discount_id`, `score_before`, `score_after`, `amount_discount_payback`, `amount_discount_create`, `amount_discount_drop`) VALUES
(1, 1, 10000, 10, '2021-06-06', 1),
(2, 10001, 50000, 15, '2021-06-06', 1),
(3, 50001, 100000, 20, '2021-06-06', 1),
(4, 100001, 500000, 25, '2021-06-06', 1),
(5, 500001, 1000000, 30, '2021-06-06', 1),
(6, 1000001, 2000000, 35, '2021-06-06', 1),
(7, 2000000, 0, 40, '2021-06-06', 1);
...
CREATE TABLE `answer_question` (
  ...
  `answer_question_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `answer_question_date` date NOT NULL,
  `answer_question_status` int(1) NOT NULL COMMENT '1.member 2.admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `banner` (
  ...
  `banner_img` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `banner` (`banner_id`, `banner_link`, `banner_img`, `banner_date`) VALUES
(1, '', 'venusheader.jpg', '2021-04-28');
...
CREATE TABLE `blogs` (
  ...
  `blogs_img` text COLLATE utf8_unicode_ci NOT NULL,
  `blogs_content` text COLLATE utf8_unicode_ci NOT NULL,
  `blogs_description` text COLLATE utf8_unicode_ci NOT NULL,
  `blogs_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `blogs_create` date NOT NULL,
  `category_blog_id` int(11) NOT NULL,
  `blogs_views` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `blogs` (`blogs_id`, `blogs_img`, `blogs_content`, `blogs_description`, `blogs_detail`, `blogs_create`, `category_blog_id`, `blogs_views`) VALUES
(1, 'bg-card.jpg', 'ต้องลองนพมาศหนิงมอนเสตอร์', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p><p><br></p><p>Why do we use it?</p><p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>', '2021-06-08', 1, 0),
(2, 'reviews1.png', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', '2021-07-07', 1, 1),
(3, 'reviews2.png', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', '2021-07-07', 1, 1),
(4, 'reviews3.png', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', 'Digital Marketing agency Landing Page Design By Mithun. Connect with them On Dribble', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', '2021-07-07', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cartmockup`
--

CREATE TABLE `cartmockup` (
  `cartmockup_id` int(11) NOT NULL,
  `cartmockup_date` date NOT NULL,
  `product_member` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `cartmockupline`
--

CREATE TABLE `cartmockupline` (
  `cartmockupline_id` int(11) NOT NULL,
  `cartmockup_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `product_total` int(11) NOT NULL,
  `product_price` double NOT NULL,
  `product_tranfer` double NOT NULL,
  `product_point` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `category` (
  ...
  `category_create` date NOT NULL,
  `category_drop` int(11) NOT NULL,
  `category_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `category_seraillab` text COLLATE utf8_unicode_ci NOT NULL,
  `category_subname` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `category` (`category_id`, `category_name`, `category_image`, `category_create`, `category_drop`, `category_detail`, `category_seraillab`, `category_subname`) VALUES
(2, 'HERO', 'picturehero.png', '2021-04-27', 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Hero-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-2.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/Hero-3.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-4.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-5.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-6.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-7.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-8.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-9.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-10.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-11.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-12.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-13.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-14.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-15.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/Hero-16.jpg\" style=\"width: 100%;\"><br></p>', '<p>อาหารเสริมฮีโร่สำหรับบำรุงร่างการของชาย <br>\n                ผ่านการผลิตจากโรงงานที่ได้รับมารตราฐาน <br>\n                มี อย. เลขที่ 10-1-10055-5-0059 <br>\n                สกัดจากสมุนไพรหลากหลายชนิด \"สุขภาพดี ชีวิตก็ดี <br>\n                เติมเต็มความสุขให้ตัวคุณด้วยฮีโร่\" <br><br>\n                <span class=\"ping\">อาการต่อมลูกหมากโต </span> <br>\n                ปัสสาวะไม่ออก ปัสสาวะไม่พุ่ง ปัสสาวะบ่อย <br>\n                อาการของโรคไต <br>\n                อาการของโรคนิ่ว <br>\n                อาการหย่อนสมรรถภาพหรือเสื่อมสมรรถภาพของร่างกาย <br>\n                เพิ่มสมรรถนะในการออกกำลังกาย ร่างกายกระซุ่มกรชวย <br>\n                ไม่เหนื่อยง่าย</p><p> <br>\n                <span class=\"ping\">สกัดจากสมุนไพรและเอนไซม์</span><br>\n                ผู้ที่มีปัญหาโรคไต สามารถทานได้ <br>\n                ผู้ที่มปัญหาเบาหวาน สามารถทานได้ <br>\n                ผู้ที่มีปัญหาความดัน สามารถทานได้ <br>\n                ไม่่มีผลข้างเคียงไม่ปวดหัว ไม่ใจสั่น ไม่ตาพล่า <br>\n                วิธีรับประทาน ผลิตภัณฑ์เสริมอาหาร ฮีโร่ วันละ 1 แคปซูล <br>\n                ก่อนอาหารเช้า</p>', 'ผลิตภัณฑ์เสริมอาหาร ตรา ฮีโร่ สตาร์'),
(3, 'FALISIA X', 'picturefalisia.png', '2021-04-27', 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-2.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-3.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-4.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-5.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-6.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-7.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-8.jpg\" style=\"width: 100%;\"></p><p><img\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-9.jpg\" style=\"width: 100%;\"><br></p>', '<p>อาหารเสริมฮีโร่สำหรับบำรุงร่างการของชาย <br>\n                ผ่านการผลิตจากโรงงานที่ได้รับมารตราฐาน <br>\n                มี อย. เลขที่ 10-1-10055-5-0059 <br>\n                สกัดจากสมุนไพรหลากหลายชนิด \"สุขภาพดี ชีวิตก็ดี <br>\n                เติมเต็มความสุขให้ตัวคุณด้วยฮีโร่\" <br><br>\n                <span class=\"ping\">อาการต่อมลูกหมากโต </span> <br>\n                ปัสสาวะไม่ออก ปัสสาวะไม่พุ่ง ปัสสาวะบ่อย <br>\n                อาการของโรคไต <br>\n                อาการของโรคนิ่ว <br>\n                อาการหย่อนสมรรถภาพหรือเสื่อมสมรรถภาพของร่างกาย <br>\n                เพิ่มสมรรถนะในการออกกำลังกาย ร่างกายกระซุ่มกรชวย <br>\n                ไม่เหนื่อยง่าย</p><p> <br>\n                <span class=\"ping\">สกัดจากสมุนไพรและเอนไซม์</span><br>\n                ผู้ที่มีปัญหาโรคไต สามารถทานได้ <br>\n                ผู้ที่มปัญหาเบาหวาน สามารถทานได้ <br>\n                ผู้ที่มีปัญหาความดัน สามารถทานได้ <br>\n                ไม่่มีผลข้างเคียงไม่ปวดหัว ไม่ใจสั่น ไม่ตาพล่า <br>\n                วิธีรับประทาน ผลิตภัณฑ์เสริมอาหาร ฮีโร่ วันละ 1 แคปซูล <br>\n                ก่อนอาหารเช้า</p>', 'ผลิตภัณฑ์อาหารเสริมตรา ฟาริเซีย'),
(4, 'FOCUS', 'picturefocus.png', '2021-04-27', 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Focus-1.jpg\"\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\n                                                              src=\"http://alive-dropship.com/images/product_detail/Focus-2.jpg\">\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-3.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-4.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-5.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-6.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-7.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-8.jpg\"><br></p>', '<p>อาหารเสริมฮีโร่สำหรับบำรุงร่างการของชาย <br>\n                ผ่านการผลิตจากโรงงานที่ได้รับมารตราฐาน <br>\n                มี อย. เลขที่ 10-1-10055-5-0059 <br>\n                สกัดจากสมุนไพรหลากหลายชนิด \"สุขภาพดี ชีวิตก็ดี <br>\n                เติมเต็มความสุขให้ตัวคุณด้วยฮีโร่\" <br><br>\n                <span class=\"ping\">อาการต่อมลูกหมากโต </span> <br>\n                ปัสสาวะไม่ออก ปัสสาวะไม่พุ่ง ปัสสาวะบ่อย <br>\n                อาการของโรคไต <br>\n                อาการของโรคนิ่ว <br>\n                อาการหย่อนสมรรถภาพหรือเสื่อมสมรรถภาพของร่างกาย <br>\n                เพิ่มสมรรถนะในการออกกำลังกาย ร่างกายกระซุ่มกรชวย <br>\n                ไม่เหนื่อยง่าย</p><p> <br>\n                <span class=\"ping\">สกัดจากสมุนไพรและเอนไซม์</span><br>\n                ผู้ที่มีปัญหาโรคไต สามารถทานได้ <br>\n                ผู้ที่มปัญหาเบาหวาน สามารถทานได้ <br>\n                ผู้ที่มีปัญหาความดัน สามารถทานได้ <br>\n                ไม่่มีผลข้างเคียงไม่ปวดหัว ไม่ใจสั่น ไม่ตาพล่า <br>\n                วิธีรับประทาน ผลิตภัณฑ์เสริมอาหาร ฮีโร่ วันละ 1 แคปซูล <br>\n                ก่อนอาหารเช้า</p>', 'ผลิตภัณฑ์เสริมอาหาร ตรา โฟกัส'),
(5, 'NAKARA', 'picturenakara.png', '2021-04-27', 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Nakara-1.jpg\"\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\n                                                              src=\"http://alive-dropship.com/images/product_detail/Nakara-2.jpg\">\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-3.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-4.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-5.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-6.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-7.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-8.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-9.jpg\"><br></p>', '<p>อาหารเสริมฮีโร่สำหรับบำรุงร่างการของชาย <br>\n                ผ่านการผลิตจากโรงงานที่ได้รับมารตราฐาน <br>\n                มี อย. เลขที่ 10-1-10055-5-0059 <br>\n                สกัดจากสมุนไพรหลากหลายชนิด \"สุขภาพดี ชีวิตก็ดี <br>\n                เติมเต็มความสุขให้ตัวคุณด้วยฮีโร่\" <br><br>\n                <span class=\"ping\">อาการต่อมลูกหมากโต </span> <br>\n                ปัสสาวะไม่ออก ปัสสาวะไม่พุ่ง ปัสสาวะบ่อย <br>\n                อาการของโรคไต <br>\n                อาการของโรคนิ่ว <br>\n                อาการหย่อนสมรรถภาพหรือเสื่อมสมรรถภาพของร่างกาย <br>\n                เพิ่มสมรรถนะในการออกกำลังกาย ร่างกายกระซุ่มกรชวย <br>\n                ไม่เหนื่อยง่าย</p><p> <br>\n                <span class=\"ping\">สกัดจากสมุนไพรและเอนไซม์</span><br>\n                ผู้ที่มีปัญหาโรคไต สามารถทานได้ <br>\n                ผู้ที่มปัญหาเบาหวาน สามารถทานได้ <br>\n                ผู้ที่มีปัญหาความดัน สามารถทานได้ <br>\n                ไม่่มีผลข้างเคียงไม่ปวดหัว ไม่ใจสั่น ไม่ตาพล่า <br>\n                วิธีรับประทาน ผลิตภัณฑ์เสริมอาหาร ฮีโร่ วันละ 1 แคปซูล <br>\n                ก่อนอาหารเช้า</p>', 'ผลิตภัณฑ์เสริมอาหาร ตรา นาคารา'),
(6, 'VENUS HERB', 'picturevenusherb.png', '2021-04-27', 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/venus-herb-1.jpg\"\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\n                                                              src=\"http://alive-dropship.com/images/product_detail/venus-herb-2.jpg\">\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-3.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-4.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-5.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-6.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-7.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-8.jpg\"><br></p>', '<p>อาหารเสริมฮีโร่สำหรับบำรุงร่างการของชาย <br>\n                ผ่านการผลิตจากโรงงานที่ได้รับมารตราฐาน <br>\n                มี อย. เลขที่ 10-1-10055-5-0059 <br>\n                สกัดจากสมุนไพรหลากหลายชนิด \"สุขภาพดี ชีวิตก็ดี <br>\n                เติมเต็มความสุขให้ตัวคุณด้วยฮีโร่\" <br><br>\n                <span class=\"ping\">อาการต่อมลูกหมากโต </span> <br>\n                ปัสสาวะไม่ออก ปัสสาวะไม่พุ่ง ปัสสาวะบ่อย <br>\n                อาการของโรคไต <br>\n                อาการของโรคนิ่ว <br>\n                อาการหย่อนสมรรถภาพหรือเสื่อมสมรรถภาพของร่างกาย <br>\n                เพิ่มสมรรถนะในการออกกำลังกาย ร่างกายกระซุ่มกรชวย <br>\n                ไม่เหนื่อยง่าย</p><p> <br>\n                <span class=\"ping\">สกัดจากสมุนไพรและเอนไซม์</span><br>\n                ผู้ที่มีปัญหาโรคไต สามารถทานได้ <br>\n                ผู้ที่มปัญหาเบาหวาน สามารถทานได้ <br>\n                ผู้ที่มีปัญหาความดัน สามารถทานได้ <br>\n                ไม่่มีผลข้างเคียงไม่ปวดหัว ไม่ใจสั่น ไม่ตาพล่า <br>\n                วิธีรับประทาน ผลิตภัณฑ์เสริมอาหาร ฮีโร่ วันละ 1 แคปซูล <br>\n                ก่อนอาหารเช้า</p>', 'ผลิตภัณฑ์เสริมอาหาร ตรา วีนัส');
...
CREATE TABLE `category_blogs` (
  `category_blog_id` int(11) NOT NULL,
  `category_blog_name` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `category_blogs` (`category_blog_id`, `category_blog_name`) VALUES
(1, 'ทดสอบ');
...
INSERT INTO `company` (`company_id`, `company_name`, `company_tax_id`, `company_phone`, `company_address`, `company_subdistrict`, `company_district`, `company_province`, `company_zipcode`) VALUES
(1, 'wachirapan pimpa', 2147483647, '0658301201', '55/1 หมู่ 2 ', 501201, 579, 38, 50120);

-- --------------------------------------------------------

--
-- Table structure for table `compileday`
--

CREATE TABLE `compileday` (
  `compileday_id` int(11) NOT NULL,
  `compileday_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `compileday`
--

INSERT INTO `compileday` (`compileday_id`, `compileday_date`) VALUES
(1, '2021-06-01'),
(2, '2021-06-02'),
(3, '2021-06-03'),
(4, '2021-06-04'),
...
--
-- Table structure for table `compilemount`
--

CREATE TABLE `compilemount` (
  `compilemount_id` int(11) NOT NULL,
  `compilemount_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `compilemount`
--

INSERT INTO `compilemount` (`compilemount_id`, `compilemount_date`) VALUES
(1, '2021-04-06');
...
CREATE TABLE `express` (
  ...
  `ordermove_id` int(11) NOT NULL,
  `ordermoveline_id` int(11) NOT NULL,
  `express_company` text COLLATE utf8_unicode_ci NOT NULL,
  `express_serial` text COLLATE utf8_unicode_ci NOT NULL,
  `express_date` date NOT NULL,
  `express_create` date NOT NULL,
  `purchase_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `total_price` double NOT NULL,
  `origin_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `mem_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `dest_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `courier_code` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `express` (`express_id`, `ordermove_id`, `ordermoveline_id`, `express_company`, `express_serial`, `express_date`, `express_create`, `purchase_id`, `total_price`, `origin_id`, `mem_id`, `dest_id`, `courier_code`) VALUES
(1, 23, 0, 'Kerry Pickup', 'SP049289545', '2021-07-21', '0000-00-00', '212799', 30, '947014', '2472', '1256260', 'SHIPOP0005050'),
(2, 21, 0, 'EMS', 'SP049289574', '2021-07-21', '0000-00-00', '212802', 37, '947014', '2472', '1256263', 'TE337013677ST'),
(3, 24, 0, 'EMS', 'SP049293900', '2021-07-25', '0000-00-00', '213226', 37, '947014', '2472', '1256696', 'TE337014743ST'),
(4, 1, 0, 'EMS', 'SP049316389', '2021-07-30', '0000-00-00', '215368', 37, '947014', '2472', '1258950', 'TE337031675ST'),
(5, 2, 0, 'Kerry Pickup', 'SP049319934', '2021-07-30', '0000-00-00', '215723', 30, '947014', '2472', '1259305', 'SHIPOP0005400'),
(6, 4, 0, 'Kerry Pickup', 'SP049319949', '2021-07-30', '0000-00-00', '215724', 30, '947014', '2472', '1259306', 'SHIPOP0005401'),
(7, 11, 0, 'EMS', 'SP049334035', '2021-07-31', '0000-00-00', '216706', 37, '947014', '2472', '1260715', 'TE337044285ST');
...
CREATE TABLE `gallary` (
  ...
  `gallary_date` date NOT NULL,
  `gallary_link` text COLLATE utf8_unicode_ci NOT NULL,
  `gallary_content` text COLLATE utf8_unicode_ci NOT NULL,
  `gallary_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `gallary_img` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `giftbox` (
  ...
  `giftbox_content` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `giftbox_score` int(11) NOT NULL,
  `giftbox_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `giftbox_create` date NOT NULL,
  `giftbox_drop` int(1) NOT NULL COMMENT '1.open 2.close',
  `giftbox_img` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `giftbox` (`giftbox_id`, `giftbox_content`, `giftbox_score`, `giftbox_detail`, `giftbox_create`, `giftbox_drop`, `giftbox_img`) VALUES
(1, 'ทดสอบ', 99, '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p><p><br></p><p>Why do we use it?</p><p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p><p><br></p><p><br></p>', '2021-06-01', 1, 'bg-card.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `grouplinetoken`
--

CREATE TABLE `grouplinetoken` (
  `grouplinetoken_id` int(11) NOT NULL,
  `linetoken_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `grouplinetoken_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `grouplinetoken`
--

INSERT INTO `grouplinetoken` (`grouplinetoken_id`, `linetoken_id`, `member_id`, `grouplinetoken_date`) VALUES
(2, 1, 1, '2021-06-29 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `learn_online`
--

CREATE TABLE `learn_online` (
  `learn_id` int(11) NOT NULL,
  `learn_content` text COLLATE utf8_unicode_ci NOT NULL,
  `learn_link` text COLLATE utf8_unicode_ci NOT NULL,
  `learn_create` date NOT NULL,
  `learn_Instructor` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `learn_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `learn_online`
--

INSERT INTO `learn_online` (`learn_id`, `learn_content`, `learn_link`, `learn_create`, `learn_Instructor`, `learn_type`) VALUES
(1, 'บทเรียนที่ 1 สอนการขาย', 'aH3H5dIjEBo', '2021-06-01', 'ทดสอบ', 'video');
...
CREATE TABLE `linetoken` (
  `linetoken_id` int(11) NOT NULL,
  `linetoken_name` text COLLATE utf8_unicode_ci NOT NULL,
  `linetoken_date` date NOT NULL,
  `linetoken_img` text COLLATE utf8_unicode_ci NOT NULL,
  `linetoken_status` int(1) NOT NULL COMMENT '0.open  1.close'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `linetoken` (`linetoken_id`, `linetoken_name`, `linetoken_date`, `linetoken_img`, `linetoken_status`) VALUES
(1, 'uvxqTiPNo9Y8Z24VekpbdwANd3MwVxoUHTqYE6qm3mP', '2021-04-26', 'my_group_1624890797465.jpg', 0);

-- --------------------------------------------------------

--
-- Table structure for table `log_loginmember`
--

CREATE TABLE `log_loginmember` (
  `log_loginmember_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
...
--
-- Dumping data for table `log_loginmember`
--

INSERT INTO `log_loginmember` (`log_loginmember_id`, `member_id`, `login_date`, `logout_date`) VALUES
(1, 1, '2021-05-25', '2021-05-25'),
(2, 1, '2021-05-25', '2021-05-25'),
(3, 3, '2021-05-25', '2021-05-25'),
(4, 1, '2021-05-31', '0000-00-00'),
(5, 1, '2021-06-01', '0000-00-00'),
(6, 1, '2021-06-02', '2021-06-02'),
(7, 1, '2021-06-04', '0000-00-00'),
(8, 1, '2021-06-04', '0000-00-00'),
(9, 1, '2021-06-05', '0000-00-00'),
(10, 1, '2021-06-05', '0000-00-00'),
(11, 1, '2021-06-06', '2021-06-06'),
(12, 1, '2021-06-06', '2021-06-06'),
(13, 1, '2021-06-07', '2021-06-07'),
(14, 1, '2021-06-07', '2021-06-07'),
(15, 1, '2021-06-07', '0000-00-00'),
(16, 1, '2021-06-08', '0000-00-00'),
(17, 1, '2021-06-08', '2021-06-08'),
(18, 1, '2021-06-09', '2021-06-09'),
(19, 1, '2021-06-09', '2021-06-09'),
(20, 1, '2021-06-09', '2021-06-09'),
(21, 1, '2021-06-09', '2021-06-09'),
(22, 1, '2021-06-10', '0000-00-00'),
(23, 1, '2021-06-10', '2021-06-10'),
(24, 1, '2021-06-10', '0000-00-00'),
(25, 1, '2021-06-11', '0000-00-00'),
(26, 1, '2021-06-11', '0000-00-00'),
(27, 1, '2021-06-12', '2021-06-12'),
(28, 1, '2021-06-12', '2021-06-12'),
(29, 1, '2021-06-14', '0000-00-00'),
(30, 6, '2021-06-16', '0000-00-00'),
(31, 1, '2021-06-16', '2021-06-16'),
(32, 6, '2021-06-16', '2021-06-16'),
(33, 1, '2021-06-20', '0000-00-00'),
(34, 1, '2021-06-21', '0000-00-00'),
(35, 1, '2021-06-28', '2021-06-28'),
(36, 1, '2021-06-28', '2021-06-28'),
(37, 1, '2021-06-28', '2021-06-28'),
(38, 6, '2021-06-28', '2021-06-28'),
(39, 1, '2021-06-28', '2021-06-28'),
(40, 6, '2021-06-28', '2021-06-28'),
(41, 3, '2021-06-28', '2021-06-28'),
(42, 6, '2021-06-28', '2021-06-28'),
(43, 1, '2021-06-29', '2021-06-29'),
(44, 1, '2021-06-29', '2021-06-29'),
(45, 1, '2021-06-29', '2021-06-29'),
(46, 1, '2021-07-14', '2021-07-15'),
(47, 1, '2021-07-15', '2021-07-15'),
(48, 3, '2021-07-15', '2021-07-15'),
(49, 1, '2021-07-15', '2021-07-15'),
(50, 1, '2021-07-15', '2021-07-15'),
(51, 3, '2021-07-15', '0000-00-00'),
(52, 3, '2021-07-15', '2021-07-15'),
(53, 1, '2021-07-18', '0000-00-00'),
(54, 1, '2021-07-18', '0000-00-00'),
(55, 1, '2021-07-18', '0000-00-00'),
(56, 1, '2021-07-18', '0000-00-00'),
(57, 1, '2021-07-18', '0000-00-00'),
(58, 1, '2021-07-18', '0000-00-00'),
(59, 1, '2021-07-18', '0000-00-00'),
(60, 1, '2021-07-18', '2021-07-18'),
(61, 1, '2021-07-18', '0000-00-00'),
(62, 1, '2021-07-18', '0000-00-00'),
(63, 1, '2021-07-19', '2021-07-19'),
(64, 3, '2021-07-19', '2021-07-19'),
(65, 1, '2021-07-19', '2021-07-19'),
(66, 1, '2021-07-20', '2021-07-20'),
(67, 1, '2021-07-20', '0000-00-00'),
(68, 1, '2021-07-20', '2021-07-20'),
(69, 1, '2021-07-21', '0000-00-00'),
(70, 1, '2021-07-22', '0000-00-00'),
(71, 8, '2021-07-25', '2021-07-25'),
(72, 12, '2021-07-25', '2021-07-25'),
(73, 1, '2021-07-25', '2021-07-25'),
(74, 1, '2021-07-25', '2021-07-25'),
(75, 1, '2021-07-29', '0000-00-00');
...
CREATE TABLE `member` (
  `member_id` int(11) NOT NULL,
  `member_sex` text COLLATE utf8_unicode_ci NOT NULL,
  ...
  `member_upline` int(11) NOT NULL,
  `member_pwd` text COLLATE utf8_unicode_ci NOT NULL,
  `member_idcard` text COLLATE utf8_unicode_ci NOT NULL,
  `member_create` date NOT NULL,
  `member_bank_name` text COLLATE utf8_unicode_ci NOT NULL,
  `member_bank_branch` text COLLATE utf8_unicode_ci NOT NULL,
  `member_bank_serial` text COLLATE utf8_unicode_ci NOT NULL,
  `member_bank_account` text COLLATE utf8_unicode_ci NOT NULL,
  `member_bank_deposit` text COLLATE utf8_unicode_ci NOT NULL,
  `member_position` int(11) NOT NULL,
  `member_image` text COLLATE utf8_unicode_ci NOT NULL,
  `member_status` int(11) NOT NULL,
  `member_rank` text COLLATE utf8_unicode_ci NOT NULL,
  `member_email` text COLLATE utf8_unicode_ci NOT NULL,
  `member_line` text COLLATE utf8_unicode_ci NOT NULL,
  `member_facebook` text COLLATE utf8_unicode_ci NOT NULL,
  `member_code` text COLLATE utf8_unicode_ci NOT NULL,
  `member_instagram` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `member` (`member_id`, `member_sex`, `member_name`, `member_phone`, `member_address`, `province_id`, `zipcode`, `member_upline`, `member_pwd`, `member_idcard`, `member_create`, `member_bank_name`, `member_bank_branch`, `member_bank_serial`, `member_bank_account`, `member_bank_deposit`, `member_position`, `member_image`, `member_status`, `member_rank`, `member_email`, `member_line`, `member_facebook`, `member_code`, `member_instagram`) VALUES
(1, 'ชาย', 'วชิระพันธ์ พิมพา', '0658301202', '55/1 หมู่ 2 ยุหว่า สันป่าตอง', 28, '50120', 0, '12345', '1339900080675', '2021-04-24', 'กรุงไทย', 'หางดง', '122334455', 'วชิระพันธ์ พิมพา', 'ออมทรัพย์', 0, 'download.jpeg', 1, '', '', '', '', '0000001', ''),
(13, 'ชาย', 'วฤษ พิมพา', '0658301203', '55/1 หมู่ 2 ยุหว่า สันป่าตอง', 38, '50120', 1, '282306', '7526449838135', '2021-07-26', 'กรุงเทพ', 'สันป่าตอง', '1234567890', 'วฤษ พิมพา', 'ออมทรัพย์', 0, '', 1, '', '', '', '', '0000013', ''),
(14, 'ชาย', 'วฤษญา พิมพา', '0966942479', '55/1 หมู่ 2', 38, '50120', 1, '640774', '7745374660951', '2021-07-30', 'กรุงไทย', 'สันป่าตอง', '1339900080', 'วฤษญา พิมพา', 'ออมททรัพย์', 0, '', 1, '', '', '', '', '0000014', ''),
(16, 'ชาย', 'wachirapan pimpa', '0658301201', '55/1 หมู่ 2 ยุหว่า สันป่าตอง', 38, '50120', 1, '528042', '9521113044283', '2021-07-30', 'กรุงเทพ', 'สันป่าตอง', '123456789', 'wachirapan pimpa', 'ออมทรัพย์', 0, '', 1, '', '', '', '', '0000016', '');
...
CREATE TABLE `memberpoint` (
  `memberpoint_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `memberpoint_number` double NOT NULL,
  `memberpoint_date` date NOT NULL,
  `memberpoint_price` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `memberpoint`
--

INSERT INTO `memberpoint` (`memberpoint_id`, `member_id`, `memberpoint_number`, `memberpoint_date`, `memberpoint_price`) VALUES
(1, 1, 700, '2021-06-09', 8030),
(2, 1, 200, '2021-07-15', 3080),
(3, 1, 100, '2021-07-30', 1540),
(4, 16, 200, '2021-07-31', 2470);

-- --------------------------------------------------------

--
-- Table structure for table `mockupimage`
--

CREATE TABLE `mockupimage` (
  `mockupimage_id` int(11) NOT NULL,
  `mockupimage_text` text COLLATE utf8_unicode_ci NOT NULL,
  `member_id` int(11) NOT NULL,
  `admin_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `month_end_summary`
--

CREATE TABLE `month_end_summary` (
  `mes_id` int(11) NOT NULL,
  `groupmount_id` int(11) NOT NULL,
  `discount_price` double NOT NULL,
  `position_id` int(11) NOT NULL,
  `position_price` double NOT NULL,
  `members_id` int(11) NOT NULL,
  `recommend_value` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `ordermove`
--

CREATE TABLE `ordermove` (
  `ordermove_id` int(11) NOT NULL,
  `ordermove_ref` text COLLATE utf8_unicode_ci NOT NULL,
  `ordermove_price` double NOT NULL,
  `ordermove_point` int(11) NOT NULL,
  `ordermove_amountdiscount` double NOT NULL,
  `ordermove_create` datetime NOT NULL,
  `ordermove_tranfer` double NOT NULL,
  `ordermove_address` text COLLATE utf8_unicode_ci NOT NULL,
  `province_id` int(11) NOT NULL,
  `zipcode` text COLLATE utf8_unicode_ci NOT NULL,
  `ordermove_payments` int(11) NOT NULL,
  `members_id` int(11) NOT NULL,
  `computeday_id` int(11) NOT NULL,
  `computemonth_id` int(11) NOT NULL,
  `owner_id` int(11) NOT NULL COMMENT 'ชื้อจากสมาชิกคนไหน',
  `member_original_id` int(11) NOT NULL,
  `ordermove_status_sending` text COLLATE utf8_unicode_ci NOT NULL,
  `ordermove_settlement` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ordermove`
--

INSERT INTO `ordermove` (`ordermove_id`, `ordermove_ref`, `ordermove_price`, `ordermove_point`, `ordermove_amountdiscount`, `ordermove_create`, `ordermove_tranfer`, `ordermove_address`, `province_id`, `zipcode`, `ordermove_payments`, `members_id`, `computeday_id`, `computemonth_id`, `owner_id`, `member_original_id`, `ordermove_status_sending`, `ordermove_settlement`) VALUES
(1, 'RO0000001', 1550, 0, 0, '2021-07-30 05:53:53', 50, '55/1 หมู่ 2  สันป่าตอง ยุหว่า', 38, '50120', 4, 0, 0, 0, 0, 1, '', 'เก็บปลายทาง'),
(2, 'RO0000002', 1540, 100, 10, '2021-07-30 10:21:40', 50, '', 0, '', 4, 1, 0, 0, 0, 0, '', 'เก็บปลายทาง'),
(3, 'RO0000003', 1540, 100, 10, '2021-07-30 10:22:45', 50, '', 0, '', 2, 1, 0, 0, 0, 0, '', 'เก็บปลายทาง'),
(4, 'RO0000004', 930, 100, 10, '2021-07-30 10:27:10', 50, '', 0, '', 4, 1, 0, 0, 0, 0, '', 'เก็บปลายทาง'),
(7, 'RO0000007', 1540, 100, 10, '2021-07-30 02:15:11', 50, '', 0, '', 2, 1, 0, 0, 0, 0, '', 'เก็บปลายทาง'),
(8, 'RO0000008', 1550, 0, 0, '2021-07-31 04:40:05', 50, '55/1 หมู่ 2 สันป่าตอง ยุหว่า', 38, '50120', 2, 0, 0, 0, 1, 2, '', 'เก็บปลายทาง'),
(9, 'RO0000009', 930, 100, 10, '2021-07-31 08:21:01', 50, '', 0, '', 2, 0, 0, 0, 0, 3, '', 'เงินสด'),
(10, 'RO0000010', 2470, 200, 20, '2021-07-31 08:25:05', 100, '', 0, '', 2, 1, 0, 0, 0, 0, '', 'เก็บปลายทาง'),
(11, 'RO0000011', 1540, 100, 10, '2021-07-31 09:13:44', 50, '', 0, '', 4, 0, 0, 0, 16, 4, '', 'เก็บปลายทาง'),
(12, 'RO0000012', 930, 100, 10, '2021-07-31 09:31:15', 50, '', 0, '', 2, 16, 0, 0, 0, 0, '', 'เก็บปลายทาง');

-- --------------------------------------------------------

--
-- Table structure for table `ordermoveline`
--

CREATE TABLE `ordermoveline` (
  `ordermoveline_id` int(11) NOT NULL,
  `ordermove_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `ordermoveline_total` int(11) NOT NULL,
  `ordermoveline_price` double NOT NULL,
  `ordermoveline_create` date NOT NULL,
  `ordermoveline_tranfer` double NOT NULL,
  `ordermoveline_point` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ordermoveline`
--

INSERT INTO `ordermoveline` (`ordermoveline_id`, `ordermove_id`, `product_id`, `ordermoveline_total`, `ordermoveline_price`, `ordermoveline_create`, `ordermoveline_tranfer`, `ordermoveline_point`) VALUES
(1, 1, 1, 1, 1500, '2021-07-30', 50, 100),
(2, 2, 1, 1, 1500, '2021-07-30', 50, 100),
(3, 3, 1, 1, 1500, '2021-07-30', 50, 100),
(4, 4, 2, 1, 890, '2021-07-30', 50, 100),
(5, 7, 1, 1, 1500, '2021-07-30', 50, 100),
(6, 8, 1, 1, 1500, '2021-07-31', 50, 100),
(7, 9, 2, 1, 890, '2021-07-31', 50, 100),
(8, 10, 1, 1, 1500, '2021-07-31', 50, 100),
(9, 10, 2, 1, 890, '2021-07-31', 50, 100),
(10, 11, 1, 1, 1500, '2021-07-31', 50, 100),
(11, 12, 2, 1, 890, '2021-07-31', 50, 100);
...
CREATE TABLE `order_discount` (
  ...
  `order_discount_before` int(11) NOT NULL,
  `order_discount_after` int(11) NOT NULL,
  `order_discount_payback` double NOT NULL,
  `order_discount_create` date NOT NULL,
  `order_discount_drop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `order_discount` (`order_discount_id`, `order_discount_before`, `order_discount_after`, `order_discount_payback`, `order_discount_create`, `order_discount_drop`) VALUES
(1, 1, 10, 50, '2021-04-25', 1),
(2, 11, 20, 80, '2021-06-06', 1),
(3, 21, 40, 100, '2021-06-06', 1),
(4, 41, 100, 120, '2021-06-06', 1),
(5, 101, 200, 150, '2021-06-06', 1),
(6, 201, 500, 180, '2021-06-06', 1);

-- --------------------------------------------------------

--
-- Table structure for table `original_member`
--

CREATE TABLE `original_member` (
  `ormember_id` int(11) NOT NULL,
  `ormember_name` text COLLATE utf8_unicode_ci NOT NULL,
  `ormember_phone` text COLLATE utf8_unicode_ci NOT NULL,
  `ormember_address` text COLLATE utf8_unicode_ci NOT NULL,
  `province_id` int(11) NOT NULL,
  `zipcode` text COLLATE utf8_unicode_ci NOT NULL,
  `ormember_email` text COLLATE utf8_unicode_ci NOT NULL,
  `ormember_line` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `original_member`
--

INSERT INTO `original_member` (`ormember_id`, `ormember_name`, `ormember_phone`, `ormember_address`, `province_id`, `zipcode`, `ormember_email`, `ormember_line`) VALUES
(1, 'นางสาว วฤษญา พิมพา', '0658301201', '55/1 หมู่ 2  สันป่าตอง ยุหว่า', 38, '50120', '', ''),
(2, 'นาย วชิระพันธ์ พิมพา', '0658301201', '55/1 หมู่ 2 สันป่าตอง ยุหว่า', 38, '50120', '', ''),
(3, 'น้อง อาโป พิมพา', '0658301201', '55/1 หมู่ 2 สันป่าตอง ยุหว่า', 38, '50120', '', ''),
(4, 'น้องอังเปา พิมพา', '0966942479', '55/1 หมู่ 2 สันป่าตอง ยุหว่า', 38, '50120', '', '');
...
CREATE TABLE `position` (
  ...
  `position_price` double NOT NULL,
  `position_to` double NOT NULL,
  `postion_payback` int(11) NOT NULL,
  `postion_date` date NOT NULL,
  `postion_drop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `position` (`position_id`, `position_name`, `position_price`, `position_to`, `postion_payback`, `postion_date`, `postion_drop`) VALUES
(1, 'ตำแหน่งsilver', 30000, 149999, 4, '2021-04-22', 1);
...
CREATE TABLE `product` (
  ...
  `product_admin` int(11) NOT NULL,
  `product_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `category_id` int(11) NOT NULL,
  `product_tranfer` double NOT NULL,
  `product_point` int(11) NOT NULL,
  `product_promotion` text COLLATE utf8_unicode_ci NOT NULL,
  `product_queryty` text COLLATE utf8_unicode_ci NOT NULL,
  `product_properties` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `product` (`product_id`, `product_name`, `product_cost_price`, `product_selling_price`, `product_profit`, `member_id`, `product_status`, `product_create`, `product_stock`, `product_admin`, `product_detail`, `category_id`, `product_tranfer`, `product_point`, `product_promotion`, `product_queryty`, `product_properties`) VALUES
(1, 'Hero(ฮีโร สตาร์)', 1000, 1500, 500, 0, 1, '2021-04-25', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Hero-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-2.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\r\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/Hero-3.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-4.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-5.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-6.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-7.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-8.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-9.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-10.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-11.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-12.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-13.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-14.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-15.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-16.jpg\" style=\"width: 100%;\"><br></p>', 2, 50, 100, '1 กระปุก (ขนาดบรรจุ กระปุกละ 30 แคปซูล)', 'รวม 30 แคปซูล', '<p>ฮีโร่ Hero 1 แถม 1</p><p>ขนาดบรรจุ 1 กล่องใหญ่ บรรจุ 30 แคปซูล / 1 กล่องเล็ก บรรจุ 4 แคบซูล (รวมทั้งหมด 34 แคปซูล)</p><p>สรรพคุณของสมุนไพรต่าง ๆ</p><p>ขมิ้นสกัด : ช่วยบำรุงหูรูดและรักษาอาการปัสสาวะขัด</p><p>เก๋ากี่สกัด : บำรุงเลือด ดับ และไต ระบบทางเดินปัสสาวะ</p><p>โปรตีนทั่วเหลือง : ช่วยขับปัสสาวะ ช่วยลดอาการเกิดโรคนิ่วในใด</p><p>กระชายดำสกัด : รักษาอาการต่อมลูกหมากโต</p><p>โสมเกาหลีสกัด : เป็นยาบำรุงกำลัง บำรุงอวัยวะภายในร่างกาย</p><p>ถังเช่า : ช่วยเสริมสร้างระบบภูมิคุ้มกันของร่างกาย รักษาโรคไตและตับ</p><p>เห็ดหอมสกัด : เสริมการทางทำงานระบบภูมิคุ้มกันร่างกาย เพิ่มประสิทธิภาพการไหลเวียนโลหิต</p>'),
(2, 'ฟาลิเซีย X', 500, 890, 390, 0, 1, '2021-04-25', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\r\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-2.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-3.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-4.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-5.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-6.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-7.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-8.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-9.jpg\" style=\"width: 100%;\"><br></p>', 3, 50, 100, '1 กระปุก (ขนาดบรรจุ กระปุก ละ 10 แคปซูล)', 'รวม 10 แคปซูล', '<p>ผลิตภัณฑ์อาหารเสริมตรา ฟาริเซีย</p><p>ฟาลิเซียร์ เอ๊กซ์ นวัฒกรรมเอนไซม์ ทีมีคุณภาพ</p><p>ช่วยเสริมสร้างภูมิคุ้มกันให้กับร่างกาย ฟื้นฟู</p><p>มี อย. เลขที่ 10-1-10055-5-0045</p><p>ข้อดีของฟาลิเซียร์ เอ๊กซ์</p><p>- ปัสสาสะวะบ่อย ปัสสาวะเล็ด ปัสสาสวะแสบ ปัสสาสะวะไม่สุด</p><p>กะปริดกะปรอย กลั้นไม่อยู่</p><p>- กระเพาะปัสสาสะวะอีกเสบเรื้อรัง</p><p>- ระบบทางเดินปัสสาวะอักเสบ</p><p>- กรวยไตอักเสบ</p><p>- เบาหวาน น้ำตาลและคลอเลสเตอรอลสูง</p><p>- ภูมิแพ้ ไอ จาม น้ำหมูกไหล</p><p>- น้ำเหลืองไม่ดี</p><p>- นอนไม่หลับ นอนหลับยาก</p><p>- อ่อนเพลีย ไม่มีเรี่ยวแรง</p><p>- ระบบเผาผลาญไม่ดี</p><p>- การสร้างเสริมภูมิต้านทาน</p>'),
(3, 'นาคารา', 200, 390, 190, 0, 1, '2021-04-23', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Nakara-1.jpg\"\r\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\r\n                                                              src=\"http://alive-dropship.com/images/product_detail/Nakara-2.jpg\">\r\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-3.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-4.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-5.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-6.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-7.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-8.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-9.jpg\"><br></p>', 5, 50, 100, '1 กล่อง (ขนาดบรรจุ กล่อง ละ 40 แคปซูล)', 'รวม 40 แคปซูล', '<p>สมันไพรนาคารา บรรเทาอาการปวดเมื่อย เส้นยึด เส้นตึง ปวดหลัง</p><p>ปวดเอว ปวดขา เส้นยึด เส้นตึง นิ้วล็อค กระดูกทับเส้น มีฟังผืดเกาะ</p><p>เสริมการรักษาอาการของโรครูมาตอยต์ เกาต์ บรรเทาได้ด้วย</p><p>\"สมุนไพรนาคารา\"</p><p>สมุนไพรนาคารา ผลิตจากโรงงานที่ได้รับมาตราฐาน</p><p>- อาหารเสริมบำรุงสุขภาพ</p><p>- บรรเทาอาการปวดเมื่อย</p><p>- ปวดหลัง</p><p>- ปวดเข่า</p><p>- เส้นยึด</p><p>- เส้นตึง</p><p>- ชาตามปลายนิ้ว</p><p>- กระดูกทับเส้น</p><p>- พังผืดเกาะ</p><p>- ริดสีดวงทวาร</p><p>- สมุนไพรนาคาราช่วยได้</p>'),
(4, 'โฟกัส', 500, 990, 490, 0, 1, '2021-04-25', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Focus-1.jpg\"\r\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\r\n                                                              src=\"http://alive-dropship.com/images/product_detail/Focus-2.jpg\">\r\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-3.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-4.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-5.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-6.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-7.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Focus-8.jpg\"><br></p>', 4, 50, 100, '1 กระปุก แถม 2 ประปุก (ขนาดบรรจุ กระปุก ละ 10 แคปซูล)', 'รวม 30 แคปซูล', '<p>โฟกัส Focus คือผลิตภัณฑ์เสริมอาหาร บำรุงสายตาและสมอง</p><p>ส่วนประกอบหลักมาจากธรรมชาติ</p><p>ทั้งหมดประสานร่วมกันเป็นเอนไซม์ประสิทธิภาพสูงสุด</p><p>​โฟกัสเหมาะสำหรับผู้ที่ต้องการดูแล</p><p>- ตาพร่า ตามัว ตาฝ่าฝาง มองไม่ชัด</p><p>- อาการเสื่อมของสายตา จอประสาทตาหลุดลอก</p><p>- จอประสาทตาเสื่อม อักเสบ เยื่อบุดวงตาอักเสบ</p><p>- ต้อลม ต้อกระจก ต้อเนื้อ ต้อหิน วุ้นในตาเสื่อม</p><p>- ตาแห้ง แสบ เคืองตา แพ้แสงน้ำตาไหล</p><p>- ความเครียด จากการใช้สายตาและสมองมากเกินไป</p><p>- สมองมีการอ่อนล้า ทำให้ไม่กระปรี้กระเปร่า จากการอดนอน</p><p>อยู่หน้าจอคอมหรือโทรศัพท์นาน</p><p>- ความจำไม่ดี จากการเสื่อมของเซลล์สมอง</p>'),
(5, 'วีนัส เฮิร์บ', 300, 490, 190, 0, 1, '2021-04-25', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/venus-herb-1.jpg\"\r\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\r\n                                                              src=\"http://alive-dropship.com/images/product_detail/venus-herb-2.jpg\">\r\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-3.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-4.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-5.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-6.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-7.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-8.jpg\"><br></p>', 6, 50, 100, '1 กล่อง (ขนาดบรรจุ กล่อง ละ 30 แคปซูล)', 'รวม 30 แคปซูล', '<p>Venus Herb อาหารเสริมที่ดูแลสุขภาพภายในของผู้หญิง</p><p>ตอบโจทย์หลายปัญหาของผู้หญิง ช่วยบัรุงระบบภายใน</p><p>ระบบเลือด ปรับสมดุลฮอร์โมน</p><p>ดูแลทุกส่วนของร่างกายจากภายในสู่ภายนอก</p><p>- ปัญหาระบบภายใน เลือดไหลเวียนไม่ดี ขาดสมดุลในร่างกาย</p><p>- อาการปวดประจำเดือน ประจำเดือนมาไม่ปกติ</p><p>- อาการตกขาว</p><p>- ช่องคลอดและมดลูกไม่กระชับ มดลูกแห้ง</p><p>- กลิ้นไม่พึงประสงค์</p><p>- ผิวพรรณไม่เปล่งปลัง ไม่สดใส ไม่มีออร่า</p><p>- ปัญหาการเกิดฝ้า กระ สิว หน้าหมองคล้ำ</p><p>- อาการวัยทอง ร้อนวูบวาบ หงุดหงิดง่าย</p><p><br></p><p>อาหารเสริมวินัส ดูแลสุขภาพภายในของผู้หญิง</p><p>ผ่านการผลิตจากโรงงานที่ได้รับมาตรฐาน ​GMP</p><p>และมีทะเบียนยาเลขที่ G668/59 สกัดจากสมุนไพรนานาชนิด</p><p>ทานวีนัสบำรุงเป็นประจำ เรียกความมั่นใจของผู้ปญิงเรากลับมา</p>'),
(7, 'Hero(ฮีโร สตาร์)', 500, 990, 490, 0, 1, '2021-04-27', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Hero-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-2.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\r\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/Hero-3.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-4.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-5.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-6.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-7.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-8.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-9.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-10.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-11.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-12.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-13.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-14.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-15.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/Hero-16.jpg\" style=\"width: 100%;\"><br></p>', 2, 50, 100, '2 กล่อง แถมฟรี 1 กล่อง (ขนาดบรรจุ กล่องละ 4 แคปซูล)', 'รวม 12 แคปซูล', '<p>ฮีโร่ Hero 1 แถม 1</p><p>ขนาดบรรจุ 1 กล่องใหญ่ บรรจุ 30 แคปซูล / 1 กล่องเล็ก บรรจุ 4 แคบซูล (รวมทั้งหมด 34 แคปซูล)</p><p>สรรพคุณของสมุนไพรต่าง ๆ</p><p>ขมิ้นสกัด : ช่วยบำรุงหูรูดและรักษาอาการปัสสาวะขัด</p><p>เก๋ากี่สกัด : บำรุงเลือด ดับ และไต ระบบทางเดินปัสสาวะ</p><p>โปรตีนทั่วเหลือง : ช่วยขับปัสสาวะ ช่วยลดอาการเกิดโรคนิ่วในใด</p><p>กระชายดำสกัด : รักษาอาการต่อมลูกหมากโต</p><p>โสมเกาหลีสกัด : เป็นยาบำรุงกำลัง บำรุงอวัยวะภายในร่างกาย</p><p>ถังเช่า : ช่วยเสริมสร้างระบบภูมิคุ้มกันของร่างกาย รักษาโรคไตและตับ</p><p>เห็ดหอมสกัด : เสริมการทางทำงานระบบภูมิคุ้มกันร่างกาย เพิ่มประสิทธิภาพการไหลเวียนโลหิต</p>'),
(8, 'ฟาลิเซีย X', 1000, 1390, 390, 0, 1, '2021-04-27', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\r\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-2.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-3.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-4.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-5.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-6.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-7.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-8.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-9.jpg\" style=\"width: 100%;\"><br></p>', 3, 50, 100, '2 กระปุก แถม 1 กระปุก (ขนาดบรรจุ กระปุกละ 10 แคปซูล)', 'รวม 30 แคปซูล', '<p>ผลิตภัณฑ์อาหารเสริมตรา ฟาริเซีย</p><p>ฟาลิเซียร์ เอ๊กซ์ นวัฒกรรมเอนไซม์ ทีมีคุณภาพ</p><p>ช่วยเสริมสร้างภูมิคุ้มกันให้กับร่างกาย ฟื้นฟู</p><p>มี อย. เลขที่ 10-1-10055-5-0045</p><p>ข้อดีของฟาลิเซียร์ เอ๊กซ์</p><p>- ปัสสาสะวะบ่อย ปัสสาวะเล็ด ปัสสาสวะแสบ ปัสสาสะวะไม่สุด</p><p>กะปริดกะปรอย กลั้นไม่อยู่</p><p>- กระเพาะปัสสาสะวะอีกเสบเรื้อรัง</p><p>- ระบบทางเดินปัสสาวะอักเสบ</p><p>- กรวยไตอักเสบ</p><p>- เบาหวาน น้ำตาลและคลอเลสเตอรอลสูง</p><p>- ภูมิแพ้ ไอ จาม น้ำหมูกไหล</p><p>- น้ำเหลืองไม่ดี</p><p>- นอนไม่หลับ นอนหลับยาก</p><p>- อ่อนเพลีย ไม่มีเรี่ยวแรง</p><p>- ระบบเผาผลาญไม่ดี</p><p>- การสร้างเสริมภูมิต้านทาน</p>'),
(9, 'ฟาลิเซีย X', 2000, 2390, 390, 0, 1, '2021-04-27', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\r\n</p><p><img src=\"http://alive-dropship.com/images/product_detail/FalisiaX-2.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-3.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-4.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-5.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-6.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-7.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-8.jpg\" style=\"width: 100%;\"></p><p><img\r\n            src=\"http://alive-dropship.com/images/product_detail/FalisiaX-9.jpg\" style=\"width: 100%;\"><br></p>', 3, 50, 100, '3 กระปุก แถมฟรี 3 กล่อง (ขนาดบรรจุ กระปุกละ 30 แคปซูล)', 'รวม 60 แคปซูล', '<p>ผลิตภัณฑ์อาหารเสริมตรา ฟาริเซีย</p><p>ฟาลิเซียร์ เอ๊กซ์ นวัฒกรรมเอนไซม์ ทีมีคุณภาพ</p><p>ช่วยเสริมสร้างภูมิคุ้มกันให้กับร่างกาย ฟื้นฟู</p><p>มี อย. เลขที่ 10-1-10055-5-0045</p><p>ข้อดีของฟาลิเซียร์ เอ๊กซ์</p><p>- ปัสสาสะวะบ่อย ปัสสาวะเล็ด ปัสสาสวะแสบ ปัสสาสะวะไม่สุด</p><p>กะปริดกะปรอย กลั้นไม่อยู่</p><p>- กระเพาะปัสสาสะวะอีกเสบเรื้อรัง</p><p>- ระบบทางเดินปัสสาวะอักเสบ</p><p>- กรวยไตอักเสบ</p><p>- เบาหวาน น้ำตาลและคลอเลสเตอรอลสูง</p><p>- ภูมิแพ้ ไอ จาม น้ำหมูกไหล</p><p>- น้ำเหลืองไม่ดี</p><p>- นอนไม่หลับ นอนหลับยาก</p><p>- อ่อนเพลีย ไม่มีเรี่ยวแรง</p><p>- ระบบเผาผลาญไม่ดี</p><p>- การสร้างเสริมภูมิต้านทาน</p>'),
(10, 'นาคารา', 500, 690, 190, 0, 1, '2021-04-27', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/Nakara-1.jpg\"\r\n        style=\"font-size: 1rem; width: 100%;\"><br></p><p><img style=\"width: 100%;\"\r\n                                                              src=\"http://alive-dropship.com/images/product_detail/Nakara-2.jpg\">\r\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-3.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-4.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-5.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-6.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-7.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-8.jpg\"></p><p><img\r\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/Nakara-9.jpg\"><br></p>', 5, 50, 100, '2 กล่อง (ขนาดบรรจุ กล่อง ละ 40 แคปซูล)', 'รวม 80 แคปซูล', '<p>สมันไพรนาคารา บรรเทาอาการปวดเมื่อย เส้นยึด เส้นตึง ปวดหลัง</p><p>ปวดเอว ปวดขา เส้นยึด เส้นตึง นิ้วล็อค กระดูกทับเส้น มีฟังผืดเกาะ</p><p>เสริมการรักษาอาการของโรครูมาตอยต์ เกาต์ บรรเทาได้ด้วย</p><p>\"สมุนไพรนาคารา\"</p><p>สมุนไพรนาคารา ผลิตจากโรงงานที่ได้รับมาตราฐาน</p><p>- อาหารเสริมบำรุงสุขภาพ</p><p>- บรรเทาอาการปวดเมื่อย</p><p>- ปวดหลัง</p><p>- ปวดเข่า</p><p>- เส้นยึด</p><p>- เส้นตึง</p><p>- ชาตามปลายนิ้ว</p><p>- กระดูกทับเส้น</p><p>- พังผืดเกาะ</p><p>- ริดสีดวงทวาร</p><p>- สมุนไพรนาคาราช่วยได้</p>'),
(11, 'วีนัส เฮิร์บ', 500, 990, 490, 0, 1, '2021-04-27', 100, 1, '<p><img src=\"http://alive-dropship.com/images/product_detail/venus-herb-1.jpg\" style=\"font-size: 1rem; width: 100%;\"><br>\n</p><p><img style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-2.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-3.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-4.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-5.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-6.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-7.jpg\"></p><p><img\n            style=\"width: 100%;\" src=\"http://alive-dropship.com/images/product_detail/venus-herb-8.jpg\"><br></p>', 6, 50, 100, '2 กล่อง แถมฟรี 1 กล่อง (ขนาดบรรจุ กล่อง ละ 30 แคปซูล)', 'รวม 90 แคปซูล', '<p>Venus Herb อาหารเสริมที่ดูแลสุขภาพภายในของผู้หญิง</p><p>ตอบโจทย์หลายปัญหาของผู้หญิง ช่วยบัรุงระบบภายใน</p><p>ระบบเลือด ปรับสมดุลฮอร์โมน</p><p>ดูแลทุกส่วนของร่างกายจากภายในสู่ภายนอก</p><p>- ปัญหาระบบภายใน เลือดไหลเวียนไม่ดี ขาดสมดุลในร่างกาย</p><p>- อาการปวดประจำเดือน ประจำเดือนมาไม่ปกติ</p><p>- อาการตกขาว</p><p>- ช่องคลอดและมดลูกไม่กระชับ มดลูกแห้ง</p><p>- กลิ้นไม่พึงประสงค์</p><p>- ผิวพรรณไม่เปล่งปลัง ไม่สดใส ไม่มีออร่า</p><p>- ปัญหาการเกิดฝ้า กระ สิว หน้าหมองคล้ำ</p><p>- อาการวัยทอง ร้อนวูบวาบ หงุดหงิดง่าย</p><p><br></p><p>อาหารเสริมวินัส ดูแลสุขภาพภายในของผู้หญิง</p><p>ผ่านการผลิตจากโรงงานที่ได้รับมาตรฐาน ​GMP</p><p>และมีทะเบียนยาเลขที่ G668/59 สกัดจากสมุนไพรนานาชนิด</p><p>ทานวีนัสบำรุงเป็นประจำ เรียกความมั่นใจของผู้ปญิงเรากลับมา</p>');
...
CREATE TABLE `product_discount` (
  ...
  `product_discount_date` datetime NOT NULL,
  `product_discount_percent` double NOT NULL,
  `product_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `product_discount` (`product_discount_id`, `price_before`, `price_discount`, `product_discount_date`, `product_discount_percent`, `product_id`) VALUES
(1, 990, 900, '2021-05-31 03:23:43', 9.0909090909091, 11),
(2, 690, 600, '2021-05-31 04:55:46', 13.04347826087, 10);
...
INSERT INTO `product_image` (`product_img_id`, `product_id`, `product_img`, `member_id`, `admin_id`) VALUES
(1, 1, 'picturehero.jpg', 0, 1),
(2, 2, 'picturefalisia.jpg', 0, 1),
(3, 3, 'picturenakara.jpg', 0, 1),
(4, 4, 'picturefocus.jpg', 0, 1),
(5, 5, 'picturevenusherb.jpg', 0, 1),
(7, 7, 'imageheropackage3.jpg', 0, 1),
(8, 8, 'falisiax2box.jpg', 0, 1),
(9, 9, 'falisiax3box.jpg', 0, 1),
(10, 10, 'imagenakara2package.jpg', 0, 1),
(13, 11, 'imagevenus3.jpg', 0, 1),
(14, 1, 'hero.png', 0, 1),
(15, 7, 'hero.png', 0, 1),
(16, 12, 'luk.jpg', 0, 1);
...
INSERT INTO `province` (`id`, `code`, `name`, `name_en`, `geography_id`) VALUES
...
CREATE TABLE `question` (
  ...
  `question_detail` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `question` (`question_id`, `question_content`, `question_detail`, `question_date`, `member_id`) VALUES
(1, 'ทดสอบ', '<p>ทดสอบ</p>', '2021-06-06', 1),
(2, 'ทดสอบ', '<p>ทดสอบ</p>', '2021-06-16', 1);

-- --------------------------------------------------------

--
-- Table structure for table `selectgiftbox`
--

CREATE TABLE `selectgiftbox` (
  `selectgiftbox_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `member_point` double NOT NULL COMMENT 'point ที่นำเข้าก่อนตัด',
  `giftbox_id` int(11) NOT NULL,
  `selectgiftbox_date` date NOT NULL,
  `selectgiftbox_status` int(1) NOT NULL COMMENT '1.รอตรวจสอบ 2.ยืนยัน 3.มีปัญหา',
  `selectgiftbox_droppoint` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `selectgiftbox`
--

INSERT INTO `selectgiftbox` (`selectgiftbox_id`, `member_id`, `member_point`, `giftbox_id`, `selectgiftbox_date`, `selectgiftbox_status`, `selectgiftbox_droppoint`) VALUES
(1, 1, 400, 1, '2021-07-31', 2, 99);

-- --------------------------------------------------------

--
-- Table structure for table `setting_lineup`
--

CREATE TABLE `setting_lineup` (
  `setting_lineup_id` int(11) NOT NULL,
  `setting_lineup_layer` int(11) NOT NULL,
  `setting_lineup_payback` int(11) NOT NULL,
  `lineup_members` int(11) NOT NULL,
  `lineup_members_to` int(11) NOT NULL,
  `setting_lineup_date` date NOT NULL,
  `setting_lineup_drop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `setting_lineup`
--

INSERT INTO `setting_lineup` (`setting_lineup_id`, `setting_lineup_layer`, `setting_lineup_payback`, `lineup_members`, `lineup_members_to`, `setting_lineup_date`, `setting_lineup_drop`) VALUES
(1, 1, 8, 2, 9, '2021-04-25', 1),
(2, 2, 8, 10, 19, '2021-06-06', 1),
(3, 3, 8, 20, 29, '2021-06-06', 1),
(4, 4, 8, 30, 49, '2021-06-06', 1),
(5, 5, 8, 50, 100, '2021-06-06', 1);

-- --------------------------------------------------------

--
-- Table structure for table `sliper`
--

CREATE TABLE `sliper` (
  `sliper_id` int(11) NOT NULL,
  `ordermove_id` int(11) NOT NULL,
  `sliper_img` text COLLATE utf8_unicode_ci NOT NULL,
  `sliper_price` double NOT NULL,
  `sliper_tranfer_date` date NOT NULL,
  `sliper_create` date NOT NULL,
  `sliper_status` int(11) NOT NULL,
  `sliper_cash` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `sliper`
--

INSERT INTO `sliper` (`sliper_id`, `ordermove_id`, `sliper_img`, `sliper_price`, `sliper_tranfer_date`, `sliper_create`, `sliper_status`, `sliper_cash`) VALUES
(1, 2, 'download1.jpeg', 1550, '2021-04-18', '2021-04-25', 2, ''),
(2, 6, 'paymentgateway.jpg', 4840, '2021-05-24', '2021-05-24', 2, '');
...
INSERT INTO `social` (`social_id`, `social_name`, `social_link`, `member_id`) VALUES
(1, 'Facebook', 'https://www.facebook.com/productalive', 0),
(2, 'Line', '@aliveshop', 0),
(3, 'Instagram', '', 0),
(4, 'Youtube', 'https://www.youtube.com/channel/UCeoO-u4iDC5qi9yhELrvjRA', 0);

-- --------------------------------------------------------

--
-- Table structure for table `subdirectory`
--

CREATE TABLE `subdirectory` (
  `subdirectory_id` int(11) NOT NULL,
  `subdirectory_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_webname` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_keyword` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_analytics` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_pixcel` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdirectory_date` date NOT NULL,
  `member_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `subdirectory`
--

INSERT INTO `subdirectory` (`subdirectory_id`, `subdirectory_name`, `subdirectory_webname`, `subdirectory_keyword`, `subdirectory_description`, `subdirectory_analytics`, `subdirectory_pixcel`, `subdirectory_date`, `member_id`) VALUES
(1, 'wachirapan', 'test', 'test', 'test', 'test', 'test', '2021-06-05', 1),
(2, 'arpo', 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', '', '2021-06-28', 6);
...
--
-- Indexes for table `abount`
--
ALTER TABLE `abount`
  ADD PRIMARY KEY (`abount_id`);
...
--
-- Indexes for table `amount_discount`
--
ALTER TABLE `amount_discount`
  ADD PRIMARY KEY (`amount_discount_id`);
...
--
-- Indexes for table `cartmockup`
--
ALTER TABLE `cartmockup`
  ADD PRIMARY KEY (`cartmockup_id`);

--
-- Indexes for table `cartmockupline`
--
ALTER TABLE `cartmockupline`
  ADD PRIMARY KEY (`cartmockupline_id`);
...
--
-- Indexes for table `compileday`
--
ALTER TABLE `compileday`
  ADD PRIMARY KEY (`compileday_id`);

--
-- Indexes for table `compilemount`
--
ALTER TABLE `compilemount`
  ADD PRIMARY KEY (`compilemount_id`);
...
--
ALTER TABLE `giftbox`
  ADD PRIMARY KEY (`giftbox_id`);

--
-- Indexes for table `grouplinetoken`
--
ALTER TABLE `grouplinetoken`
  ADD PRIMARY KEY (`grouplinetoken_id`);

--
-- Indexes for table `learn_online`
--
ALTER TABLE `learn_online`
...
ALTER TABLE `linetoken`
  ADD PRIMARY KEY (`linetoken_id`);

--
-- Indexes for table `log_loginmember`
--
ALTER TABLE `log_loginmember`
  ADD PRIMARY KEY (`log_loginmember_id`);
...
ALTER TABLE `memberpoint`
  ADD PRIMARY KEY (`memberpoint_id`);

--
-- Indexes for table `mockupimage`
--
ALTER TABLE `mockupimage`
  ADD PRIMARY KEY (`mockupimage_id`);

--
-- Indexes for table `month_end_summary`
--
ALTER TABLE `month_end_summary`
  ADD PRIMARY KEY (`mes_id`);

--
-- Indexes for table `ordermove`
--
ALTER TABLE `ordermove`
  ADD PRIMARY KEY (`ordermove_id`);

--
-- Indexes for table `ordermoveline`
--
ALTER TABLE `ordermoveline`
  ADD PRIMARY KEY (`ordermoveline_id`);
...
--
-- Indexes for table `original_member`
--
ALTER TABLE `original_member`
  ADD PRIMARY KEY (`ormember_id`);
...
--
-- Indexes for table `selectgiftbox`
--
ALTER TABLE `selectgiftbox`
  ADD PRIMARY KEY (`selectgiftbox_id`);

--
-- Indexes for table `setting_lineup`
--
ALTER TABLE `setting_lineup`
  ADD PRIMARY KEY (`setting_lineup_id`);

--
-- Indexes for table `sliper`
--
ALTER TABLE `sliper`
  ADD PRIMARY KEY (`sliper_id`);
...
--
-- Indexes for table `subdirectory`
--
ALTER TABLE `subdirectory`
  ADD PRIMARY KEY (`subdirectory_id`);
...
--
-- AUTO_INCREMENT for table `abount`
--
ALTER TABLE `abount`
  MODIFY `abount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `amount_discount`
--
ALTER TABLE `amount_discount`
  MODIFY `amount_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `answer_question`
  MODIFY `answer_question_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `cartmockup`
--
ALTER TABLE `cartmockup`
  MODIFY `cartmockup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `cartmockupline`
--
ALTER TABLE `cartmockupline`
  MODIFY `cartmockupline_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `category_blogs`
  MODIFY `category_blog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `compileday`
--
ALTER TABLE `compileday`
  MODIFY `compileday_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `compilemount`
--
ALTER TABLE `compilemount`
  MODIFY `compilemount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `express`
  MODIFY `express_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `giftbox`
  MODIFY `giftbox_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `grouplinetoken`
--
ALTER TABLE `grouplinetoken`
  MODIFY `grouplinetoken_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `learn_online`
--
ALTER TABLE `learn_online`
  MODIFY `learn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `linetoken`
--
ALTER TABLE `linetoken`
  MODIFY `linetoken_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `log_loginmember`
--
ALTER TABLE `log_loginmember`
  MODIFY `log_loginmember_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `memberpoint`
  MODIFY `memberpoint_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `mockupimage`
--
ALTER TABLE `mockupimage`
  MODIFY `mockupimage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `month_end_summary`
--
ALTER TABLE `month_end_summary`
  MODIFY `mes_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ordermove`
--
ALTER TABLE `ordermove`
  MODIFY `ordermove_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ordermoveline`
--
ALTER TABLE `ordermoveline`
  MODIFY `ordermoveline_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `order_discount`
--
ALTER TABLE `order_discount`
  MODIFY `order_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `original_member`
--
ALTER TABLE `original_member`
  MODIFY `ormember_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `selectgiftbox`
--
ALTER TABLE `selectgiftbox`
  MODIFY `selectgiftbox_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `setting_lineup`
--
ALTER TABLE `setting_lineup`
  MODIFY `setting_lineup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sliper`
--
ALTER TABLE `sliper`
  MODIFY `sliper_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `subdirectory`
--
ALTER TABLE `subdirectory`
  MODIFY `subdirectory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
