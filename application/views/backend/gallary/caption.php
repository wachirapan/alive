                    ...
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <?php foreach ($gallary as $item){?>
                                <tr>
                                    <td><img src="<?=base_url('images/gallary/'.$item->gallary_img)?>" style="width: 50px; height: 50px; border-radius: 50%"></td>
                                    <td><?=$item->gallary_content?></td>
                                    <td><?=$item->gallary_link?></td>
                                    <td><a href="<?=$item->gallary_link?>" target="_blank"><i class="fa fa-download fa-lg" ></i></a></td>
