        ...
        <div class="card mb-4">
            ...
            <div class="row" style="padding: 20px">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-background" onclick="confirmcontact();"><i class="fa fa-save"></i>
                        บันทึกข้อมูล
                    </button>
                </div>
            </div>
...
<script>
    ...
    function confirmcontact() {
        if (confirm('ยืนยันการบันทึกข้อมูลนี้หรือไม่')) {
            $.post("<?=site_url('BInsertData/create_ans_contact')?>", {
                question_id: $("#question_id").val(),
                editor: $('#editor').val()
            }, function () {
                location.href = "<?=site_url('Backend/contact_us')?>";
            });
        }
    }
</script>