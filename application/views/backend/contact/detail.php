    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="row" style="padding: 20px">
                <div class="col-md-12">
                    <?php $headercontent = $this->BQueryView->get_question($_GET['question_id']);
                    foreach ($headercontent as $item) {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row" style="padding: 20px">
                                ...
                                <?php $ans = $this->BQueryView->get_answer_question($_GET['question_id']);
                                foreach ($ans as $o) {
                                    ?>
                                    <div class="col-md-12">
                    ...
                    <?php } ?>
                    <a href="<?= site_url('Backend/answer_contact?question_id=' . $_GET['question_id']) ?>">
