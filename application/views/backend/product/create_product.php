            ...
            <div class="row" style="padding: 20px">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-background" onclick="create_category();"><i class="fa fa-save"></i>
                                จัดเก็บข้อมูล
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function create_product() {
        if (confirm('ยินยันการจัดเก็บข้อมูลนี้หรือไม่')) {
            $.post("<?=site_url('BInsertData/create_product')?>", {
    ...
    var myDropzone = new Dropzone("#my-dropzone", {
        ...
        removedfile: function (file) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo site_url("dropzone/Product/remove") ?>",
                data: {file: name},
                dataType: 'html'
            });
        ...
        accept: function (file, done) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo site_url("dropzone/Product/insertdb") ?>",
        ...
        init: function () {
            var me = this;
            $.get("<?php echo site_url("dropzone/Product/list_files") ?>", function (data) {
