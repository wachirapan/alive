                ...
                <div class="row" style="padding: 20px">
                    <div class="col-md-12" style="margin-top: 2%">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category" onchange="create_category();">
                                ...
                                foreach ($category as $item) {
                                    ?>
                                    <option value="<?= $item->category_blog_id ?>"><?= $item->category_blog_name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="content_detail">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function create_product() {
        if (confirm('ยินยันการจัดเก็บข้อมูลนี้หรือไม่')) {
            $.post("<?=site_url('AInsertData/create_blogs')?>",{
