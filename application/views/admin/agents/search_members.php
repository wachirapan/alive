                        ...
                        <div class="col-md-8 col-12">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" onclick="search_members();">ค้นหาตัวแทน</span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div style="width: 40px; height: 40px; background-color: #fcabb9; border-radius: 50%">
                                                    <?php if ($item->member_image == '') { ?>
                                                        <img class="img-profile rounded-circle"
                                                             src="<?= base_url('assets/wbackend/') ?>img/boy.png"
                                            ...
                                            <div class="col-md-10">
                                                <p><?= $item->member_code ?><br/>
                                                    <span style="color: #fcabb9; font-size: 12px">Update 1 day ago</span>
                                                </p>
                                            </div>
                                        </div>

                                    </td>
                                    <td class="text-nowrap"><p><?= $item->member_name ?> <br> <span style="color: #fcabb9; font-size: 10px">on 24.05.2019</span>
                                        </p></td>
                                    <td class="text-nowrap"><p><?= $item->member_create ?> <br> <span style="color: #fcabb9; font-size: 10px">6:30 PM</span>
                                        </p>
                                    </td>
                                    <td class="text-nowrap">
                                        <a href="<?=site_url('WAController/editprofilemember?member_id='.$item->member_id)?>">
