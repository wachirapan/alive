                ...
                foreach ($product as $o) {
                    ...
                    <div class="col-md-12">
                        <div class="row">
                                    ...
                                    <select class="form-control" id="category">
                                        ...
                                        foreach ($cate as $s) {
                                            ...
                                            <option value="<?= $s->category_id ?>"
                                                    selected><?= $s->category_name ?></option>
                                        <?php } ?>
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-background" onclick="update_product();"><i
                                            class="fa fa-save"></i> จัดเก็บข้อมูล
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function update_product() {
        if (confirm('ยินยันการจัดเก็บข้อมูลนี้หรือไม่')) {
            $.post("<?=site_url('AUpdateData/update_product')?>", {
