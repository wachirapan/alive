    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="row" style="padding: 20px">
                <?php $giftbox = $this->AQueryView->get_editgiftbox($_GET['giftbox_id']);
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div style="border: solid 1px; height: 150px; width: 150px; margin: auto;border-radius: 5%; "
                                     id="boximage">
                                    <img src="<?= base_url('images/gift_box/' . $item->giftbox_img) ?>" id="output"
                                         width="150px" height="150px"/>
                                </div>
                                <div class="form-group">
                                    <label>รูปภาพ (512 x 512)</label>
                                    <input type="hidden" id="review_picture" name="review_picture"
                                           value="<?= $item->giftbox_img ?>">
                                    <input type="file" class="form-control" id="picture_header"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="editor" name="editor"><?= $item->giftbox_detail ?></textarea>
                                </div>
                                <button class="btn btn-background" onclick="updategiftbox();"><i class="fa fa-save"></i>
                                    บันทึกข้อมูล
                                </button>
                            </div>
                        </div>
...
<input type="hidden" id="giftbox_id" value="<?= $_GET['giftbox_id'] ?>">
<script>
    ...
    function updategiftbox() {
        if (confirm('ยืนยันการบันทึกข้อมูลนี้หรือไม่')) {
            $.post("<?=site_url('AUpdateData/update_giftbox')?>", {
