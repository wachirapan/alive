    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="row" style="padding: 20px">
                <div class="col-md-12">
                    <form action="<?= site_url('AController/purchase_ordersearch') ?>" method="get" target="_blank">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="main_cate" name="main_cate">
                                        ...
                                        <?php $category = $this->AQueryView->category();
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-nonbackground form-control" style="margin-top: 14%"><i
                                            class="fa fa-search"></i>
                                    ค้นหา
                                </button>
                            </div>
                            <div class="col-md-6">
                                <a href="<?= site_url('AController/cartshoping') ?>">
...
<script>
    ...
    function confirmcart() {
        if (confirm("ยินยันการสั่งชื้อสินค้านี้หรือไม่")) {
            $.post("<?=site_url('AInsertData/cartmockup')?>", {
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                            <img id="image-product" style="width: 100%; height: auto">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h4>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend minus">
                                        <span class="input-group-text " style="border:1px solid #f7a4b2!important; color: #f7a4b2; background-color: white"> - </span>
                                    </div>
                        ...
                        <button type="button" class="btn btn-background" onclick="confirmcart();" data-dismiss="modal" style="width: 120px">
                            ยืนยัน
                        </button>
                    </div>
                </div>
